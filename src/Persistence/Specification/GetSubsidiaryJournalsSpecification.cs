...
public class GetSubsidiaryJournalsCountSpecification : Specification<SubsidiaryJournal>
{
    public GetSubsidiaryJournalsCountSpecification(GetSubsidiaryJournalsRequest request)
    {
